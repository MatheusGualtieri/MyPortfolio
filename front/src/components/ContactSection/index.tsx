...
export const ContactSection = () => {
  return (
    <div className="w-full md:h-[600px] flex justify-center gap-8">
      <div className="w-full box-border p-8 max-w-[1200px] flex flex-col gap-8">
        ...
        <ul className="flex flex-col md:flex-row items-center gap-12 md:justify-between">
          <li className="flex flex-col  items-center ">
            <a
              className="group"
              href={`mailto:${"matheus.gualtieri56@gmail.com"}`}
              target="_blank"
            >
              <MdEmail
                className="w-32 h-32 text-rose-400 group-hover:text-rose-600 transition-all duration-300"
                href={``}
              />
            </a>
            ...
            <p className="text-center text-stone-600 dark:text-stone-300">
              matheus.gualtieri56@gmail.com
            </p>
          </li>
          <li className="flex flex-col  items-center">
            <a
              target="_blank"
              href={`https://api.whatsapp.com/send?phone=+55+${11957690495}&text=Ol%C3%A1%2C%20venho%20por%20meio%20do%20seu%20portf%C3%B3lio%20na%20internet%2C%20gostaria%20de%20conhecer%20melhor%20seus%20servi%C3%A7os`}
              className="group"
            >
          ...
          <li className="flex flex-col  items-center">
            <a
              className="group"
              target="_blank"
              href={"https://github.com/MatheusGualtieri"}
            >
          ...
          <li className="flex flex-col  items-center">
            <a
              ...
              target="_blank"
              href={
                "https://www.linkedin.com/in/matheus-gualtieri/?profileId=ACoAAC0GkFYBRDBzjfAP8OkL0kyrwQvbSrEjKI0"
              }
            >
